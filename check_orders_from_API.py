...
list_of_orders_days = ['250007916', '250007954', '250007992', '250008005', '250008023', '250008028', '250008047',
                       ...
                       '250010053', '250010055', '240526047', '240526064', '240526088', '240526132', '240526200',
...
class GetExistData:
    ...
    def get_data_of_date_order(self, dispatch, destination, day_start, day_end, point_disp, point_dest, number):
        ...
        if day_start in [0, 1, 2, 3, 4, 5] and number not in ['250008288', '250008418']:  # тут проверяем если приходит нужный день недели
