...
token_debug_bot = "264498281:AAGpVqga9RQBKp7umUEcZsxENMYp3Oj2RQw"  # Для проверки Дадаты6951649128:AAHb3triQhmOw7omlTsVyN8waiTzurvvzjI
...
value_places = str(random.randint(3, 99))
...
# Вес (выберем рандомно)
value_insurance = str(random.randint(10000, 100000))
...
individual_phone_with_symbols = "+7 (999) 022-00-38"
individual_phone_2_full = "79817842624"
individual_phone_2 = "9817842624"
individual_phone_with_symbols_2 = "+7 (981) 784-26-24"
...
"""Города"""
cities = ['Санкт-Петербург', 'Красноярск', 'Москва', 'Брянск', 'Сыктывкар', 'Краснодар', 'Новосибирск', 'Барнаул',
          'Тюмень', 'Тверь', 'Волгоград', 'Екатеринбург', 'Астрахань', 'Мурманск', 'Рязань', 'Вологда',
          'Самара', 'Владивосток', 'Архангельск', 'Казань', 'Владимир', 'Липецк']

addresses = ["ул Ленина", "наб Кутузова, д 88", "ул Бабушкина, д 88", "проспект Наставников 35 к1", "мкр Баянаул", 'ул 2-я Брянская']

cities_another_countries = ['Минск', 'Алматы', 'Астана', 'Гродно']
