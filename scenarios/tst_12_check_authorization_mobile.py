...
def check_authorization_mobile(params):
    main_description = "Тест №12 - Проверка авторизации (номер телефона)"
    status_and_name_tst = {}

    try:
        """1. Авторизация на главной странице https://vozovoz.org/"""
        def authorization_on_the_main_page():
            description = "Авторизация на главной странице https://vozovoz.org/"
            try:
        ...
        """2. Авторизация на странице https://vozovoz.org/personal/auth/"""
        def authorization_on_the_page_personal_auth():
            description = "Авторизация на странице https://vozovoz.org/personal/auth/"
            try:
                for key, value in mobile.items():
        ...
        status_and_name_tst = authorization_on_the_main_page()
        status_and_name_tst = authorization_on_the_page_personal_auth()
