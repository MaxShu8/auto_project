...
def running_for_debug():
    ...
    tests = [check_authorization_email, check_authorization_mobile]
...
def running_of_all():
    """Названия новых тестов добавлять в список tests для прогона очередью"""
    tests = [check_authorization_mobile, sending_feedback_forms, checking_the_choice_of_another_currency, checking_the_category_selection,
             checking_input_search_number_order, check_creating_an_individual_ka, check_creating_legal_entity_ka,
